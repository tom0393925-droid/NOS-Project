...
`IM_Dashboard_User_Manual_v1.pptx`（保存先: `OneDrive/ドキュメント/Intern/Manual/`）

| スライド | 内容 |
|----------|------|
| 1–18 | IM Dashboardの基本操作・各タブの使い方 |
| 19 | Client Insights — 概要（3つの主要機能の説明） |
| 20 | データのアップロード手順（"Sales By Item (Customer)" Excel） |
| 21 | クライアント選択とKPIカードの読み方 |
| 22 | 購買トレンドグラフ・SKU構成ドーナツチャートの操作方法 |
| 23 | アクティブSKU・休眠SKUの一覧と活用方法 |
| 24 | 用語集（SKU・WOS・Safety Stock・ABCランクなど） |
